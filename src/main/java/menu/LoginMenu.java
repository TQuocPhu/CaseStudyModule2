...
//        String password;
//        while (true) {
//            System.out.print("Nhập mật khẩu (ít nhất 6 ký tự, có chữ và số): ");
//            password = scanner.nextLine();
//            if (!Pattern.matches("^(?=.*[A-Za-z])(?=.*\\d)[A-Za-z\\d]{6,}$", password)) {
//                System.out.println("Mật khẩu phải có ít nhất 6 ký tự và chứa cả chữ và số!");
//                continue;
//            }
//            break;
//        }
...
//                break;
//            }
//            System.out.println("Giới tính chỉ được nhập 'Nam' hoặc 'Nữ' hoặc 'Khác'!");
//        }
//
//        String role = "user"; // mặc định user khi đăng ký
//
